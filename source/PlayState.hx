...
//----------------------------------------------------------------
    ...
    mobileControls.visible = false;
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/CameraMovement.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/dialog4.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/HealthDrain.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/IntroText.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/StageEvent4.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/dialog1.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/StageEvent1.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/dialogue3-1.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/dialogue3-2.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/dialog5.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/FXs.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/FXText.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/SimpleHealthbar.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/StageEvent5.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/Symbols.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/dialogue2-1.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/dialogue2-2.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
		...
		#if LUA_ALLOWED
		var doPush:Bool = false;
		var luaFile = Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/StageEvent2.lua');
		if (OpenFlAssets.exists(luaFile))
		{
			doPush = true;
		} 
